...
const validStory: StoryScript = {
  ...
  beats: [
    { index: 1, narration: "where you are who is with you.", sensory_detail: "the chair is firm", child_action: null },
    { index: 2, narration: "it squeezes it is not the needle.", sensory_detail: "tight squeeze, not sharp", child_action: null },
    { index: 3, narration: "cold wet this is not the needle either.", sensory_detail: "cold and wet", child_action: null },
    { index: 4, narration: "it will hurt briefly honest comparator how long.", sensory_detail: "a sharp pinch, then pressure", child_action: null },
    { index: 5, narration: "what you are allowed to do. You can choose to look away.", sensory_detail: null, child_action: "look away" },
    { index: 6, narration: "it is over how long it took.", sensory_detail: "pressure, then a small plaster", child_action: null },
    { index: 7, narration: "what you keep.", sensory_detail: null, child_action: null },
  ],
